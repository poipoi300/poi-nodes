...
class Stitcher:
    ...
    def _apply_inset_blend(self, mask, blend_distance, is_top_edge=False, is_left_edge=False, is_bottom_edge=False, is_right_edge=False):
        ...
        padded_mask = F.pad(binary_mask, (pad_size, pad_size, pad_size, pad_size), mode='constant', value=0)
        ...
        print(f"Smoothed result range: {result_smoothed.min():.3f} - {result_smoothed.max():.3f}")
